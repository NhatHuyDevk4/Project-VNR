...
export default function TextExplainerUI({
  ...
  return (
    ...
    >
      <div className="bg-white/95 backdrop-blur-xl rounded-xl shadow-2xl border border-amber-200 p-3 max-w-xs">
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 bg-gradient-to-br from-amber-100 to-amber-200 rounded-lg flex items-center justify-center shrink-0 border border-amber-300 shadow-sm">
            <Lightbulb className="w-4 h-4 text-amber-700" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-xs text-gray-700 mb-2 line-clamp-2 italic font-medium">
              "
          ...
          <Button
            ...
            className="shrink-0 -mt-1 -mr-1 hover:bg-amber-50 text-gray-600 h-6 w-6"
          >
            <X className="w-3 h-3" />
          </Button>
        </div>
