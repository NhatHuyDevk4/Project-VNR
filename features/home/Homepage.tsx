...
const Homepage = () => {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center relative max-w-4xl mx-auto">
      ...
      <div className="w-full border-[6px] border-double border-ink/20 p-4 md:p-8 lg:p-12 relative bg-[#F9F1E1] shadow-document group transition-all duration-700 hover:border-ink/30">
        ...
        <div className="mt-16 flex justify-center">
           <Link 
              href="/contents"
              className="group/btn relative inline-flex items-center gap-3 px-8 py-4 bg-ink text-[#F5E6C8] font-archival uppercase tracking-widest text-lg md:text-xl font-bold transition-all duration-300 hover:bg-seal shadow-document hover:shadow-document-hover overflow-hidden rounded-sm"
           >
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center w-full">
           <div className="font-mono text-[10px] md:text-xs text-ink/40 tracking-widest">
